...
from monai.transforms import LoadImaged, Compose, ScaleIntensityRanged, Resized, EnsureTyped, RandRotated, ConcatItemsd, ToTensord, CenterSpatialCropd, RandZoomd, RandFlipd
...
train_transforms = Compose(
    [
        ...
        ScaleIntensityRanged(keys=["ct"], a_min=-1024, a_max=3071, b_min=0, b_max=1, clip=False),
        ScaleIntensityRanged(keys=["pet"], a_min=0, a_max=106, b_min=0, b_max=1, clip=False),
        ...
        RandFlipd(keys=["ct","pet"], prob=1.0, spatial_axis=1),                                                                                                              
        RandZoomd(keys=["ct","pet"], prob=1.0, min_zoom=0.5, max_zoom=0.5),                                                                                                              
