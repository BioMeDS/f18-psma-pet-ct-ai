...
from monai.transforms import LoadImaged, Compose, ScaleIntensityd, Resized, EnsureTyped, RandRotated, ConcatItemsd, ToTensord
...
train_data, val_data = load_train_val_data(cropped=False, suv=False)
